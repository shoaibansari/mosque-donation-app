...
{{--	<link href="{{ toolbox()->backend()->asset('/css/material-icons.css') }}" rel="stylesheet" type="text/css">--}}
	...
	<link href="{{ toolbox()->backend()->asset('/css/custom.css') }}" rel="stylesheet">
	@yield('head')
</head>
<body class="theme-indigo" data-url="{{ toolbox()->backend()->url() }}" data-assets-url="{{ toolbox()->backend()->assetsUrl() }}">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="">
						<a href="{{ route('admin.logout') }}" class="logout" data-toggle="" role="button">
	...
	<section>
		@include( toolbox()->backend()->view('partials.sidebar-left') );
		{{--
		@include( toolbox()->backend()->view('partials.sidebar-right') );
		--}}
	</section>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					@endif
					@include( toolbox()->backend()->view('partials.messages') )
				</div>
			</div>
			@yield('contents')
		</div>
	...
	<script>
        ...
        function sessionChecker( ) {
            appHelper.ajax('{{ route('admin.check.session') }}', {
                method: 'GET',
                block: false,
                success: function (r) {
                    if (r.expired == 'yes') {
