...
<html lang="en">
<head>
	<title>@section('title') {{ 'Backoffice::'. settings()->getAppName() }} @show</title>
	...
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/method-draw/editor/lib/jgraduate/css/jPicker.css') }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/method-draw/editor/lib/jgraduate/css/jgraduate.css' ) }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/method-draw/editor/css/method-draw.css') }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/method-draw/editor/css/fonts.css') }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/method-draw/editor/custom/styles.css') }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/tooltipster/dist/css/tooltipster.bundle.min.css') }}" type="text/css"/>
	<link rel="stylesheet" href="{{ toolbox()->asset('plugins/font-awesome/css/font-awesome.css') }}" type="text/css">
	<link href="{{ toolbox()->asset('plugins/chosen/chosen.min.css') }}" rel="stylesheet">
	
	
	<!--{endif}-->
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
	<meta name="apple-mobile-web-app-capable" content="yes"/>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/jquery.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/bootstrap/js/bootstrap.js') }}"></script>
	
	<!--{if svg_edit_release}>
	  <script type="text/javascript" src="method-draw.compiled.js"></script>
	<!{else}-->
	
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/pathseg.js?v=1') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/touch.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/js-hotkeys/jquery.hotkeys.min.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/icons/jquery.svgicons.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/jgraduate/jquery.jgraduate.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/contextmenu/jquery.contextMenu.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/jquery-ui/jquery-ui-1.8.17.custom.min.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/browser.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/svgtransformlist.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/math.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/units.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/svgutils.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/sanitize.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/history.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/select.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/draw.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/path.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/dialog.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/svgcanvas.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/src/method-draw.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/jquery-draginput.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/contextmenu.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/jgraduate/jpicker.min.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/mousewheel.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/extensions/ext-eyedropper.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/extensions/ext-shapes.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/extensions/ext-grid.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/requestanimationframe.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/taphold.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/filesaver.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/canvg/canvg.js') }}"></script>
	<script type="text/javascript" src="{{ toolbox()->asset('plugins/method-draw/editor/lib/canvg/rgbcolor.js') }}"></script>
	...
	<script src="{{ toolbox()->asset('/plugins/chosen/chosen.jquery.min.js')}}"></script>
	
	{{-- custom library --}}
	<script type="text/javascript" src="{{ toolbox()->backend()->asset('/js/lib.js') }}"></script>
...
<div id="ajax-spinner" style="display:none;">
	<img src="{{ toolbox()->backend()->asset('images/loader/editor-preloader.gif') }}"/>
</div>
<div id="svg_editor">
	...
	<div id="menu_bar">
		...
		<div class="menu">
			...
			<div class="menu_list" id="edit_menu">
				...
				<div class="menu_item action_selected disabled" id="tool_copy">Copy <span class="shortcut">⌘C</span>
				</div>
				<div class="menu_item action_selected disabled" id="tool_paste">Paste <span class="shortcut">⌘V</span>
				</div>
				<div class="menu_item action_selected disabled" id="tool_clone">Duplicate
					<span class="shortcut">⌘D</span></div>
		...
		<div class="menu">
			...
			<div class="menu_list" id="object_menu">
				<div class="menu_item action_selected disabled" id="tool_move_top">Bring to Front
					<span class="shortcut">⌘⇧↑</span></div>
				<div class="menu_item action_selected disabled" id="tool_move_up">Bring Forward <span class="shortcut">⌘↑</span>
				</div>
				<div class="menu_item action_selected disabled" id="tool_move_down">Send Backward
					<span class="shortcut">⌘↓</span></div>
				<div class="menu_item action_selected disabled" id="tool_move_bottom">Send to Back
					<span class="shortcut">⌘⇧↓</span></div>
				<div class="separator"></div>
				<div class="menu_item action_multi_selected disabled" id="tool_group">Group Elements
					<span class="shortcut">⌘G</span></div>
				<div class="menu_item action_group_selected disabled" id="tool_ungroup">Ungroup Elements
					<span class="shortcut">⌘⇧G</span></div>
				<div class="separator"></div>
	...
	<div id="tools_left" class="tools_panel">
		...
		<div class="tool_button" id="tool_logo" title="{{ settings()->getAppName() }}" style="background: none;">
			<a href="javascript:;" onclick="confirm('Do you want to exit?') ? window.location = '{{ $referrer }}' : '' ">
				<img src="{{ toolbox()->backend()->asset('/images/editor-logo.png') }}" />
			</a>
		</div>
		
		<div class="tool_button" id="tool_export_my_image" title="Save" style="padding-left: 2px; background: none; color: #ccc;">
		...
		<div class="tool_button" id="tool_fullscreen" title="Full Screen" style="padding-left: 2px">
	...
	<div id="status_bar" class="row">
		...
		<div class="col-md-3" style="padding-left: 3px; text-align: left">
			<span style="font-weight: bold">HOA: </span>
			<span class="hoa_title">{{ $photo->job->area->title }}</span>
		</div>
		
		<div class="col-md-6" style="padding-left: 3px; text-align: center">
			<span style="font-weight: bold">Address: </span>
			<span class="hoa_address">{{ $photo->location->address }}</span>
		</div>
		
		<div class="col-md-3" style="padding-right: 3px; text-align: right">
			<span style="font-weight: bold">Reported Violations Count: </span>
			<span class="hoa_violation_count">{{ $photo->violations->count() }}</span>
		</div>
		
	</div>
	<div id="tools_bottom" class="tools_panel row">
		
		<div class="col-md-3" title="Previous Location" id="prev_location">
			<i class="fa fa-arrow-circle-left fa-2x"></i>
		</div>
		
		{{--
		<div id="prev_location" title="Previous Location">
			<i class="fa fa-arrow-circle-left"></i>
		</div>
		--}}
		
		<div class="col-md-3" id="prev_image" title="Previous Image">
			<i class="fa fa-arrow-left fa-2x"></i>
		</div>
		
		<div id="zoom_panel" class="col-md-1 toolset" title="Change zoom level">
		...
		<div class="col-md-2" id="next_image" title="Next Image">
			<i class="fa fa-arrow-right fa-2x"></i>
		</div>
		
		<div class="col-md-3" id="next_location" title="Next Location">
...
<ul id="cmenu_canvas" class="contextMenu">
	@foreach( $allViolations as $id => $title )
		<li>
			<a href="#{{ $id }}" onclick="myEditor.addViolation( event, this )" data-id="{{ $id }}">
				{{ $title }}
			</a>
		</li>
	@endforeach
	<li class="separator"><a href="#new-violation" onclick="myEditor.addViolation( event, this, true );" data-id="{{ $id }}">New Violation</a></li>
</ul>

{{-- Violation Modal --}}
<div id="dlgViolation" class="modal fade" role="dialog">
	<div class="modal-dialog">
		{!! Form::open( ['route' => 'admin.location.violation.store', 'method' => 'post', 'files' => true]) !!}
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Review Violations</h4>
				<p>Please review the violations you want to report on this location's photo.</p>
			</div>
			<div class="modal-body">
				{{ Form::hidden('location_photo_id', $photo->id, ['id' => 'location_photo_id', 'required' => 'required']) }}
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<div class="form-line">
								{{ Form::label('violations[]', 'Selected Violation *') }}
								{{ Form::select('violations[]', $allViolations, null, ['class' => 'form-control chosen-select violations', 'multiple' => 'multiple', 'required' => 'required']) }}
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<div class="form-line">
								{{ Form::textarea('comment', null, ['class' => 'form-control', 'placeholder'=>'The homeowner will see these comments in the discussion.', 'required' => 'required']) }}
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-footer">
				{{ Form::button('Save', ['class'=>'btn btn-primary waves-effect btn-save']) }}
				{{ Form::button('Cancel', ['class'=>'btn btn-default btn-cancel']) }}
			</div>
		</div>
		{!! Form::close() !!}
	</div>
...
<script>
    ...
    var zoomLock = false;
    var zoomLockValue = 100;
    var $panzoom = null;
	
    methodDraw.setCanvasSize = function (w, h) {
        methodDraw.curConfig.dimensions = [w, h];
    }
    methodDraw.hideMenu = function () {
        $('#menu_bar').hide();
        $('#tools_left').css({top: 0});
        $('.touch div#workarea, div#workarea').css({top: '4px'});
        $('#tools_top').css({top: 0});
    }
		...
		pngsave: function(win, data) {
			...
			canvg(c, data.svg, {
				renderCallback: function() {
                    //myEditor.doSaveRequest( c.toDataURL('image/png') );       // <-- Generate 5 times bigger file then original
                    myEditor.doSaveRequest( c.toDataURL('image/jpeg', 0.95) );
				}
			});
		}
    ...
    // tools: select, pencil, line, rect, circle, path, text, zoom
    methodDraw.hideTools = function (tools) {
        ...
        insertNewImage = function (img_width, img_height) {
            var newImage = methodDraw.canvas.addSvgElementFromJson({
                ...
                "attr": {
                    ...
                    "width": img_width,
                    "height": img_height,
                    "id": methodDraw.canvas.getNextId(),
                    "style": "pointer-events:none"
                }
            });
            methodDraw.canvas.setHref(newImage, imageUrl);
            methodDraw.canvas.selectOnly([newImage]);
            methodDraw.canvas.alignSelectedElements("m", "page");
            methodDraw.canvas.alignSelectedElements("c", "page");
            methodDraw.updateContextPanel();
        }
    ...
    myEditor.requestImageData = null;
    myEditor.stackPosition = 0;
    
    myEditor.init = function() {
        methodDraw.curConfig.imgPath = '{{ toolbox()->asset('plugins/method-draw/editor/images/') }}';
        methodDraw.curConfig.jGraduatePath = '{{ toolbox()->asset('plugins/method-draw/editor/lib/jgraduate/images/') }}';
        methodDraw.curConfig.showRulers = false;
        methodDraw.hideMenu();
	    methodDraw.hideTools(['zoom', 'path', 'line', 'pencil']);
        methodDraw.init();
        setTimeout(function () {
    ...
    myEditor.loadImage = function( imageUrl, width, height ) {

        methodDraw.canvas.setBackground("#ccc", ""); // <-- important to avoid flickering image
        methodDraw.clearAll(width, height);
	    
        if ( width && height ) {
            methodDraw.setCanvasSize(width, height); // not tested, original it was blocked.
            methodDraw.canvas.setResolution(width, height);
        }
        methodDraw.canvas.setBackground('red', imageUrl);
        methodDraw.createImageBackground(width, height, imageUrl);
    }
    

    /**
     * Request server for next/prev images
     *
     * @param elm
     * @param url
     * @param save
     */
    myEditor.doImageRequest = function(elm, url) {

        var isChanged = false;
        if ( methodDraw.canvas.undoMgr.getUndoStackSize() > 3) {
            isChanged = true;
        }
        
        // if image is already saved, then check is there any changes after saving.
        if ( myEditor.stackPosition > 0 && myEditor.stackPosition === methodDraw.canvas.undoMgr.getUndoStackSize()) {
            isChanged = false;
        }

        console.log('doRequest...', isChanged, methodDraw.canvas.undoMgr.getUndoStackSize(), myEditor.stackPosition);
        
	    // If a change is detected, then first confirm from user that he want to save changes by showing a
	    // dialog-box. Also, in this case, next/prev request will be handle in methodDraw.setCustomHandlers() function.
        if ( isChanged ) {
            myEditor.showDialog({
                elm: elm,
                url: url,
        ...
        myEditor.sendImageRequest( elm, url );
    }
    
    myEditor.sendImageRequest = function(elm, url) {
        //var btn = $(elm);
        
        myEditor.requestImageData = null;
        myEditor.stackPosition = 0;
        
        zoomLockValue = $('#zoom').val();
        console.log('Requesting for next image...', zoomLockValue);
        appHelper.ajax(url + '/' + $('#location_photo_id').val(), {
            blockMessage: $('#ajax-spinner'),
            success: function (response) {

                console.log('Handling response...', response);
                
                // updating location-photo-id
                $('#location_photo_id').val( response.data.location_photo_id );
                $('.hoa_title').html( response.data.hoa_title );
                $('.hoa_address').html( response.data.location_address );
                $('.hoa_violation_count').html( response.data.photo_violation_count );

                // loading image
                setTimeout(function () {
                    myEditor.loadImage(response.data.image, response.data.width, response.data.height);
                    if (zoomLock) {
                        methodDraw.setZoomLevel(zoomLockValue);
                    }
                    $.unblockUI();
                }, 250);
    ...
    // Saving image and reporting violation.
    myEditor.doSaveRequest = function( file_contents ) {
        appHelper.ajax('{{ route('admin.jobs.locations.report.violation') }}', {
            'blockMessage': $('#ajax-spinner'),
            'method': 'post',
            'data': {
                'file_contents': file_contents,
                'location_photo_id': $('#location_photo_id').val(),
                'violations': $('.violations').val(),
            },
            'success': function (response) {

                // clearing selected violations from current image
                myEditor.clearViolationList();

                console.log(response);
                // if has request to pull next/prev image
                if (myEditor.requestImageData) {
                    myEditor.sendImageRequest(
                        myEditor.requestImageData.elm,
                        myEditor.requestImageData.url,
                        myEditor.requestImageData.save
                    );
                }
            },
            'fail': function (err) {
    ...
    myEditor.showDialog = function (imageRequestData, labels) {
        var dlg = $('#dlgViolation');
        myEditor.requestImageData = imageRequestData;
        {
            // changing of dialog's button's labels
            labels = !labels ? ['Save', 'Close'] : labels;
            dlg.find('.btn-save').html(labels[0]);
            dlg.find('.btn-cancel').html(labels[1]);
        }
    ...
    myEditor.hideDialog = function() {
        $('#dlgViolation').modal('hide');
    }

    myEditor.save = function () {
        methodDraw.canvas.rasterExport();
        myEditor.stackPosition = methodDraw.canvas.undoMgr.getUndoStackSize();
    }

    myEditor.addText = function ( text ) {
        methodDraw.addText( text );
        methodDraw.canvas.undoMgr.getNextUndoCommandText();
        methodDraw.canvas.undoMgr.addCommandToHistory( methodDraw.canvas.undoMgr.getNextUndoCommandText() );
    }

    var violations = [];
    myEditor.addToViolationList = function (violation_id) {
	    violations[ violations.length ] = violation_id;
        $('.violations').val( violations );
    }

    myEditor.clearViolationList = function () {
        $('.violations').val([]);
        violations = [];
    }
    
    myEditor.addViolation = function (e, elm, isNew) {
        var $me = $(elm);
        if ( isNew ) {
            var newViolationText = window.prompt("Enter new violation name:");
            console.log(newViolationText);
            if (newViolationText) {
                appHelper.ajax('{{ route('admin.violations.store') }}', {
                    method: 'post',
                    data: {
                        title: newViolationText,
                        active: 1
                    },
                    success: function (res) {
                        myEditor.addText( newViolationText );
                        // updating context menu
                        $('#cmenu_canvas li:last').prev().after('<li><a href="#'+ res.data.id +'" onclick="myEditor.addViolation( event, this )" data-id="' + res.data.id + '">' + newViolationText + '</a></li>');
                        
                        // updating violation drop-down in modal/dialog section
                        $('.violations').append('<option value="'+ res.data.id +'">'+ newViolationText + '</option>');
                        
                        // adding violation in location violation list
                        myEditor.addToViolationList( res.data.id );
                    },
                    error: function () {
                        alert("Unable to record violation in database. Please try later or consult with admin.");
                    },
                    block: false
                });
            }
            else if (newViolationText !== null) {
                alert('Violation name is required.');
                myEditor.addViolation(e, elm, isNew);
            }
        }
        else {
            //$('#violations').val( $('#violations').val() + ',' + $me.data('id') );
            myEditor.addToViolationList( $me.data('id') );
            myEditor.addText( $me.text() );
        }
    }
    ...
    $(function () {
        ...
        myEditor.init();
        myEditor.loadImage('{{ $photo->getImageUrl() }}', '{{ $photo->getImageDimensions()['width'] }}', '{{ $photo->getImageDimensions()['height'] }}');
        myEditor.doImageRequest( null, '{{ route('admin.jobs.load.location', '') }}', false);
	    
	    $('#prev_location').click(function(e) {
            myEditor.doImageRequest(this, '{{ route('admin.jobs.prev.location', '') }}');
	    });
		
		$('#next_location').click(function(e){
            myEditor.doImageRequest(this, '{{ route('admin.jobs.next.location', '') }}');
		});
		
		$('#prev_image').click(function(e) {
            myEditor.doImageRequest(this, '{{ route('admin.jobs.locations.prev.image', '') }}');
		});
		
		$('#next_image').click(function(e) {
            myEditor.doImageRequest(this, '{{ route('admin.jobs.locations.next.image', '') }}');
		});

        $(".chosen-select").chosen({no_results_text: "No violation available."});
	    
		// NOTE: contextMenu is removing all events associating with the document, so we are using 'body' here
	    // to listen the events.
		$('body').on('click', '#tool_export_my_image', function(e) {
			myEditor.showDialog(null, ['Save', 'Cancel']);
		});
	    
        $('#zoom_lock').click(function (e) {
        ...
        //
        // Violation submit button
        //
        $('body').on('click', '#dlgViolation .btn-save', function (e) {
        ...
        //
        // Violation hide button
        //
        $('body').on('click', '#dlgViolation .btn-cancel', function (e) {
            console.log('cancel is triggered.....');
            if ( $(this).text().toLowerCase() === 'ignore' ) {
                myEditor.hideDialog();
                myEditor.clearViolationList();
                if (myEditor.requestImageData) {
                    myEditor.sendImageRequest(
        ...
        $('body').on('click','#tool_fullscreen', function() {
            toggleFullScreen();
        });
