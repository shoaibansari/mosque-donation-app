	...
	<script>
		$(function() {
            ...
            $('.btn-new').on('click', function (e) {
                location.href = '{{ route('admin.mosque.create') }}';
            });

            // Edit
			$(document).on('click', '.btn-edit', function (e) {
                location.href = '{{ route('admin.mosque.edit', '') }}/' + $(this).data('id');
            });

            //View
			$(document).on('click', '.btn-view', function (e) {
               location.href = '{{ route('admin.mosque.view', '') }}/' + $(this).data('id');
            });
            ...
            $(document).on('click', '.btn-delete', function (e) {
                ...
                appHelper.confirm(e, {
                    message: 'Are you sure to delete?', 'onConfirm': function () {
                        window.location = '{{ route('admin.mosque.delete','') }}/' + me.data('id');
                    }
                });
            });
