...
<head>
	...
	<style type="text/css">
		...
		.body-wrapper {
			background: #f2f5f7 url('{{ toolbox()->frontend()->asset('email-assets/background.png') }}') no-repeat center top;
			padding: 0px;
			margin: auto;
		}
													...
													<table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;"
														...
														<tr>
															<td style="width:150px;">
																<img alt="{{ settings()->getAppName() }}" title="" height="auto" src="{{ toolbox()->frontend()->asset('email-assets/logo.png') }}"
											...
											<tr>
												<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
													<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
														<p>Hello Admin,</p>
														<p class="hero">Request for Location Approval!</p>
														<p>A home owner name <strong>{{ ucwords($name) }}</strong> has requested to allow following location:</p>
														<p>
															@foreach( $location as $type => $value )
																{{ ucwords($type) . ": " . $value }} <br>
															@endforeach
														</p>
														<p>
															<a href="{{ $approvalLink }}" class="btn" mc:disable-tracking="">Review Request</a>
														</p>
														<p>If you find this request inappropriate you can remove it from the backoffice.</p>
														<hr style="margin-top: 56px">
														<p class="mb-0">Thanks,</p>
														<p class="mb-0">The {{ settings()->getAppName() }} Team</p>
													</div>
												</td>
											</tr>
											</tbody>
											...
											<tr>
												<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="center">
													<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:14px;line-height:24px;letter-spacing:0.4px;text-align:center;">
														...
														<a href="mailto:{{ settings()->getSupportEmailAddress() }}">{{ settings()->getSupportEmailAddress() }}</a>.
													</div>
												</td>
											</tr>
											</tbody>
							...
							<tr>
								<td style="word-wrap:break-word;font-size:0px;padding:0px;" align="center">
									<table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;"
										...
										<tr>
											<td style="width:1px;">
												<img alt="" title="" height="1" src="{{ toolbox()->frontend()->asset('email-assets/pixel.png') }}"
