	...
	<div class="row clearfix">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="body">
					@if ( !isset($thisUser) )
						{!! Form::open( ['route' => 'profile.store', 'method' => 'post', 'files' => true, 'class' => 'profile-form']) !!}
					@else
						{!! Form::model( $thisUser, ['route' => ['profile.update'], 'method' => 'post', 'files' => true, 'class' => 'profile-form']) !!}
					...
					<div class="form-group">
						<div class="form-line">
							{{ Form::text('email', null, ['class' => 'form-control', 'placeholder'=>'Enter your email address', 'readonly'=>'']) }}
						</div>
					</div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<div class="body">
					...
					{!! Form::open( ['route' => 'password.update', 'method' => 'post', 'class' => 'chw-password-form']) !!}
...
@section('footer')
	{!! JsValidator::formRequest( toolbox()->userArea()->request('UserProfileUpdateRequest'), '.profile-form')  !!}
	{!! JsValidator::formRequest( toolbox()->userArea()->request('UserPasswordUpdateRequest'), '.chw-password-form')  !!}
            ...
            $('.bn-delete').click(function (e) {
                appHelper.confirm(e, {
                    message: 'Are you sure to remove avatar?', 'onConfirm': function () {
                        window.location = '{{ route('remove.avatar') }}';
                    }
                });
            });
        });
