...
(function() {
  ...
  var mouseDown = function(evt)
  {
    ...
    // if (!right_click && current_mode !== "select" ) {
    //       return;
    // }
      ...
      case "rect":
        ...
        addSvgElementFromJson({
          ...
          "attr": {
            ...
            "id": getNextId(),
            "opacity": cur_shape.opacity / 2,
            "fill": 'none',  // <-- added by adnan
            "stroke-width": "3.5" // <-- added by adnan
          }
        });
        break;
      case "line":
      ...
      case "text":
        ...
        var newText = addSvgElementFromJson({
          ...
          "attr": {
            ...
            "id": getNextId(),
            "fill": cur_text.fill,
            //"stroke-width": cur_text.stroke_width,    // commented by Adnan to avoid stroke to apply on text
            "stroke-width": 0,      // <-- added by adnan
              "stroke": '#000', // <-- added by adnan
...
//              call("selected", [selected]);
    ...
    if (!keep && element != null) {
      ...
      if ( (current_mode != "path" || !drawn_path) &&
        t.parentNode && // <-- adfriend2003@gmail.com
  ...
  var dblClick = function(evt) {
      ...
      return;   // added by adnan : (to avoid text editing)
