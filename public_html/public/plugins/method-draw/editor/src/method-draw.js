...
//            || elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
  ...
  //              var ref_data = Actions.getButtonData(opts.button);
      ...
      if(curConfig.baseUnit !== "px") {
        ...
        // Added by adnan
        Editor.createImageBackground = function (w, h, bgUrl) {
            svgCanvas.createLayer("background")
            newImage = svgCanvas.addSvgElementFromJson({
                "element": "image",
                "attr": {
                    "x": -1,
                    "y": -1,
            ...
            svgCanvas.setHref(newImage, bgUrl);
            //svgCanvas.preventClickDefault(newImage);
            svgCanvas.setCurrentLayer("Layer 1")
            svgCanvas.setCurrentLayerPosition("1")
        }

        // Added by adnan
        Editor.addText = function( text, fontSize, color, fontFamily, x, y, id) {
      ...
      Editor.setZoomLevel = function( val ) {
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
    ...
    var changeCanvasSize = function(ctl){
      ...
      Editor.openPrep = function(func) {
        ...
        Editor.updateContextPanel = function () {
           //updateContextPanel();      //todo: fix it
        }
