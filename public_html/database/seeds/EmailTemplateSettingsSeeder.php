...
class EmailTemplateSettingsSeeder extends Seeder
{
    ...
    public function run()
    {
	    ...
	    $templates[0]['sender_email'] = 'support@valuelogodesign.com';
	    $templates[0]['sender_name'] = 'Support';

	    $templates[0]['header'] =<<<BLOCK
...
<head>
  ...
  <style type="text/css">
  *{margin:0;padding:0;font-family:Helvetica,Arial,sans-serif}img{max-width:100%;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic}.image-fix{display:block}.collapse{margin:0;padding:0}body{-webkit-font-smoothing:antialiased;-webkit-text-size-adjust:none;width:100%!important;height:100%;text-align:center;color:#747474;background-color:#fff}h1,h2,h3,h4,h5,h6{font-family:Helvetica,Arial,sans-serif;line-height:1.1}h1 small,h2 small,h3 small,h4 small,h5 small,h6 small{font-size:60%;line-height:0;text-transform:none}h1{font-weight:200;font-size:44px}h2{font-weight:200;font-size:32px;margin-bottom:14px}h3{font-weight:500;font-size:27px}h4{font-weight:500;font-size:23px}h5{font-weight:900;font-size:17px}h6{font-weight:900;font-size:14px;text-transform:uppercase}.collapse{margin:0!important}td,div{font-family:Helvetica,Arial,sans-serif;text-align:center}p,ul{margin-bottom:10px;font-weight:400;font-size:14px;line-height:1.6}p.lead{font-size:17px}p.last{margin-bottom:0}ul li{margin-left:5px;list-style-position:inside}a{color:#747474;text-decoration:none}a img{border:none}.head-wrap{width:100%;margin:0 auto;background-color:#f9f8f8;border-bottom:1px solid #d8d8d8}.head-wrap *{margin:0;padding:0}.header-background{background:repeat-x url(https://www.filepicker.io/api/file/wUGKTIOZTDqV2oJx5NCh) left bottom}.header{height:42px}.header .content{padding:0}.header .brand{font-size:16px;line-height:42px;font-weight:700}.header .brand a{color:#464646}.body-wrap{width:505px;margin:0 auto;background-color:#fff}.soapbox .soapbox-title{font-size:21px;color:#464646;padding-top:35px}.content .status-container.single .status-padding{width:80px}.content .status{width:90%}.content .status-container.single .status{width:300px}.status{border-collapse:collapse;margin-left:15px;color:#656565}.status .status-cell{border:1px solid #b3b3b3;height:50px}.status .status-cell.success,.status .status-cell.active{height:65px}.status .status-cell.success{background:#f2ffeb;color:#51da42}.status .status-cell.success .status-title{font-size:15px}.status .status-cell.active{background:#fffde0;width:135px}.status .status-title{font-size:16px;font-weight:700;line-height:23px}.status .status-image{vertical-align:text-bottom}.body .body-padded,.body .body-padding{padding-top:34px}.body .body-padding{width:41px}.body-padded,.body-title{text-align:left}.body .body-title{font-weight:700;font-size:17px;color:#464646}.body .body-text .body-text-cell{text-align:left;font-size:14px;line-height:1.6;padding:9px 0 17px}.body .body-text-cell a{color:#464646;text-decoration:underline}.body .body-signature-block .body-signature-cell{padding:25px 0 30px;text-align:left}.body .body-signature{font-family:"Comic Sans MS",Textile,cursive;font-weight:700}.footer-wrap{width:100%;margin:0 auto;clear:both!important;background-color:#e5e5e5;border-top:1px solid #b3b3b3;font-size:12px;color:#656565;line-height:30px}.footer-wrap .container{padding:14px 0}.footer-wrap .container .content{padding:0}.footer-wrap .container .footer-lead{font-size:14px}.footer-wrap .container .footer-lead a{font-size:14px;font-weight:700;color:#535353}.footer-wrap .container a{font-size:12px;color:#656565}.footer-wrap .container a.last{margin-right:0}.footer-wrap .footer-group{display:inline-block}.container{display:block!important;max-width:505px!important;clear:both!important}.content{padding:0;max-width:505px;margin:0 auto;display:block}.content table{width:100%}.clear{display:block;clear:both}table.full-width-gmail-android{width:100%!important}
  </style>
...
BLOCK;
	    ...
	    DB::table( 'email_template_settings' )->truncate();
