...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2018 at 10:46 AM
...
INSERT INTO `donations` (`id`, `user_id`, `mosque_id`, `donation_title`, `donation_description`, `required_amount`, `start_date`, `end_date`, `created_at`, `updated_at`, `is_active`) VALUES
(14, 1, 91, 'Donation # 12', 'sassdasfsfs', '30000', '2018-06-05', '2018-06-30', '2018-06-02', '2018-06-02', 1),
(15, 76, 91, 'Donation sdfsf', 'asdadadadad', '3000', '2018-05-31', '2018-06-06', '2018-06-02', '2018-06-02', 1),
(16, 76, 91, 'Need help', 'need help please', '20000', '2018-06-11', '2018-06-19', '2018-06-11', '2018-06-11', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `donation_view`
-- (See below for the actual view)
--
CREATE TABLE `donation_view` (
`id` int(11)
,`name` varchar(45)
,`mosque` varchar(50)
,`title` varchar(255)
...
INSERT INTO `funds` (`id`, `user_id`, `mosque_id`, `donation_id`, `email`, `payment`, `created_at`, `updated_at`) VALUES
(1, 73, 91, 14, 'asda154@gmail.com', '100', NULL, NULL),
(2, 73, 91, 15, 'asda154@gmail.com', '20', '2018-06-03 01:59:14', '2018-06-03 01:59:14'),
(18, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-08 05:50:40', '2018-06-08 05:50:40'),
(19, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-08 05:50:40', '2018-06-08 05:50:40'),
(20, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 02:48:16', '2018-06-11 02:48:16'),
(21, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 02:49:01', '2018-06-11 02:49:01'),
(22, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-11 02:49:01', '2018-06-11 02:49:01'),
(23, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 02:49:40', '2018-06-11 02:49:40'),
(24, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-11 02:49:40', '2018-06-11 02:49:40'),
(25, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 02:49:49', '2018-06-11 02:49:49'),
(26, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-11 02:49:49', '2018-06-11 02:49:49'),
(27, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 03:54:40', '2018-06-11 03:54:40'),
(28, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-11 03:54:40', '2018-06-11 03:54:40'),
(29, 73, 91, 22, 'asda154@gmail.com', '1000', '2018-06-11 06:40:22', '2018-06-11 06:40:22'),
(30, 73, 91, 5, 'asda154@gmail.com', '1000', '2018-06-11 06:40:22', '2018-06-11 06:40:22');

-- --------------------------------------------------------

--
-- Stand-in structure for view `funds_view`
-- (See below for the actual view)
--
CREATE TABLE `funds_view` (
`id` int(11)
...
(1, 'Admin', 'admin@jaria.com', '$2y$10$WITeTOZTzrPwod7xcs881udtZ.m0cCKdKuNUHn9ezwOQsqy7GDtpW', '', NULL, 0, NULL, 1, 1, 1, NULL, NULL, '', NULL, '2018-06-07 15:32:19', 'e5CHmn3bSqzySrtyliHdUWXZS8v5ZiDixUTEjJc3RO4KMqdJMENuTO5rLiae', 0, 0),
(65, 'Mosqueasd', 'mosqueasdsa@gmail.com', '$2y$10$BajFSAw/bxERJvZ9l8q4AO7RbmxOy6Nlk11uAQ4ELTTTie2SBMa0i', '000000000', NULL, 0, NULL, 1, 2, 0, '6k07C6EE34608962g923M82a045315', NULL, NULL, '2018-05-21 06:51:05', '2018-05-21 06:51:05', 'DDk2teCV0HxrPaaIeLHtfIW7L292JS7rhhspjy6UhE0tDnFee4ARGhJ0xtJC', 1, 0),
...
(73, 'asad', 'asda154@gmail.com', '$2y$10$q5ySb61fA9r7/RTJXgCag./Xk3AgDT97NXfPhALrDz8yeXc8uXEmS', NULL, '2018-06-08 09:25:54', 0, NULL, 1, 3, 0, '', '2018-05-23 06:56:12', NULL, '2018-05-23 06:54:51', '2018-06-08 04:25:54', 'CZL6KggasSY3PZDmwCxzwjYLCo8vzKbMxAz8l6GT4rehPC86tA6LVxpK4bIh', 1, 0),
...
(76, 'Mosquesadad', 'mosques@gmail.com', '$2y$10$ordp24AjKm720vGLipsJMOUChP2t9z0r3eQk6/lMq0vQ4U/gJJOnC', '000000000', NULL, 0, NULL, 1, 2, 0, 'R50as0N932juDnMn88805333eS3An7', NULL, '', '2018-05-24 05:37:05', '2018-05-30 02:24:12', 'ebJnY4tqmJBfZRPYub79fD9a7NRVDZPHdt1DzH6S6UBtDKT67SPl4wMVIY8l', 1, 0),
(77, 'AAA', 'dfssdf@gmail.com', '$2y$10$kY.bxKuo/yOKfNn/A.bJM.91QmfFxZUauRiAEeGFW7paabpUar2Hu', '03042161678', NULL, 0, NULL, 1, 2, 0, 'Y0O8ui35CiM9U8uiz35aD7w0558S21', NULL, NULL, '2018-06-07 14:46:20', '2018-06-07 14:46:20', NULL, 1, 0),
(78, 'AAA', 'dasd@gmail.com', '', '03042161676', NULL, 0, NULL, 1, 3, 0, 'Yfv349p2N247bxK135Syor4u85f554', NULL, '78-1528359016.png', '2018-06-07 15:06:44', '2018-06-07 15:10:16', NULL, 1, 0);
...
INSERT INTO `user_accounts` (`id`, `user_id`, `payment_method`, `paypal_email`, `created_at`, `updated_at`) VALUES
(4, 73, 'paypal', 'asda154@gmail.com', '2018-06-07 03:49:30', '2018-06-07 03:49:30'),
(5, 73, 'paypal', 'asda154@gmail.com', '2018-06-07 03:51:50', '2018-06-07 03:51:50');
...
(1, 73, '9563cdbe592f755f085268e964823076867c3eea', '', '', NULL, '', 0, 0, '', '', '2018-06-08 04:25:54', '2018-05-23 06:56:17', '2018-06-08 04:25:54');

-- --------------------------------------------------------

--
-- Stand-in structure for view `user_donation_view`
-- (See below for the actual view)
--
CREATE TABLE `user_donation_view` (
`id` int(11)
,`user_id` int(11)
,`mosque` varchar(50)
,`title` varchar(255)
...
--
-- Structure for view `donation_view`
--
DROP TABLE IF EXISTS `donation_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `donation_view`  AS  select `donations`.`id` AS `id`,`users`.`name` AS `name`,`mosques`.`mosque_name` AS `mosque`,`donations`.`donation_title` AS `title`,`donations`.`donation_description` AS `description`,`donations`.`required_amount` AS `required_amount`,`donations`.`start_date` AS `start_date`,`donations`.`end_date` AS `end_date`,`donations`.`created_at` AS `created_at` from ((`donations` join `users` on((`donations`.`user_id` = `users`.`id`))) join `mosques` on((`donations`.`mosque_id` = `mosques`.`id`))) ;

-- --------------------------------------------------------

--
-- Structure for view `funds_view`
--
DROP TABLE IF EXISTS `funds_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `funds_view`  AS  select `funds`.`id` AS `id`,`funds`.`donation_id` AS `donation_id`,`funds`.`user_id` AS `user_id`,`users`.`name` AS `name`,`mosques`.`mosque_name` AS `mosque`,`donations`.`donation_title` AS `donation`,`funds`.`email` AS `email`,`funds`.`payment` AS `payment` from (((`funds` join `users` on((`funds`.`user_id` = `users`.`id`))) join `mosques` on((`funds`.`mosque_id` = `mosques`.`id`))) join `donations` on((`funds`.`donation_id` = `donations`.`id`))) ;

-- --------------------------------------------------------

--
-- Structure for view `user_donation_view`
--
DROP TABLE IF EXISTS `user_donation_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_donation_view`  AS  select `donations`.`id` AS `id`,`donations`.`user_id` AS `user_id`,`mosques`.`mosque_name` AS `mosque`,`donations`.`donation_title` AS `title`,`donations`.`required_amount` AS `required_amount`,`donations`.`end_date` AS `end_date`,`donations`.`is_active` AS `is_active`,`donations`.`created_at` AS `created_at` from ((`donations` join `users` on((`donations`.`user_id` = `users`.`id`))) join `mosques` on((`donations`.`mosque_id` = `mosques`.`id`))) ;
